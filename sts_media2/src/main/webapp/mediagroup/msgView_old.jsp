...
<head>
<meta charset="UTF-8">
<title>[mediagroup/msgView_old.jsp]</title>
...
String contextPath = request.getContextPath(); // /media

out.println("<DL>");
if (msg1 != null){  // 메시지가 있는지 검사
  out.println("<DD> <img src='"+contextPath+"/mediagroup/images/bu01.png'> " + msg1);  
}
if (msg2 != null){
  out.println("<DD> <img src='"+contextPath+"/mediagroup/images/bu01.png'> " + msg2);  
}
if (msg3 != null){
  out.println("<DD> <img src='"+contextPath+"/mediagroup/images/bu01.png'> " + msg3);  
}
if (msg4 != null){
  out.println("<DD> <img src='"+contextPath+"/mediagroup/images/bu01.png'> " + msg4);  
}
if (msg5 != null){
  out.println("<DD> <img src='"+contextPath+"/mediagroup/images/bu01.png'> " + msg5);  
}
